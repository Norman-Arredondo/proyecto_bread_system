                ...
                <div class="card shadow mb-3">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <div class="mb-3"><label class="form-label" for="codigo_postal"><strong>Código Postal</strong></label><input class="form-control" type="tel" id="codigo_postal" name="codigo_postal" maxlength="5"></div>
                            </div>   
                        </div>            
            ...
            <form id="modificar_punto" action="" method="POST">
                <div class="modal-content">
                    ...
                    <div class="modal-body" style="overflow-y: auto;">
                        ...
                        <label class="form-label" for="m_codigo_postal"><strong>Código postal:</strong></label><input class="form-control" type="tel" id="m_codigo_postal" name="m_codigo_postal" maxlength="5">
                    </div>
